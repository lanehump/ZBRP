Kits = {
    ["pistols"] = {
        ["deagle"] = {
            ...
            {item = "50cal_rounds", amount = 75, slot = 15},
        ...
        ["m9"] = {
            {item = "WEAPON_M9", primary = true, amount = 1, slot = 1},
            {item = "armour", amount = 5, slot = 2},
            {item = "oxy", amount = 30, slot = 3},
            {item = "radio", amount = 1, slot = 6},
            {item = "9mm_rounds", amount = 250, slot = 15},
...
function API.ClearItems()
    TriggerServerEvent("arena:Player:clearItems")
end
...
RegisterNUICallback("nui:arena:moveInside", API.SwapToEmpty)
