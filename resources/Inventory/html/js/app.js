...
const app = new Vue({
    ...
    watch: {
        'settings.setters.blur.set': function (state) {
            this.sendEvent('nui:arena:blurState', state)
        },
        opened(state) {
            this.sendEvent('nui:arena:openedState', {
                state: state,
    ...
    mounted: function () {
        ...
        this.sendEvent('nui:arena:mounted')
    },
    methods: {
        ...
        giveItemToTarget(targetSrc) {
            ...
            if (ref && ref.inventoryType == 'main') {
                if (this.mainInventory[ref.inventoryIndex]) {
                    ...
                    this.sendEvent('nui:arena:giveItemToTarget', {
        ...
        useItem() {
            if (this.draggedData.inventoryType == 'main') {
                if (this.mainInventory[this.draggedData.inventoryIndex]) {
                    ...
                    this.sendEvent('nui:arena:useItem', parseInt(this.draggedData.inventoryIndex + 1))
                }
            }
        },
        throwItem() {
            if (this.draggedData.inventoryType == 'main') {
                if (this.mainInventory[this.draggedData.inventoryIndex]) {
                    ...
                    this.sendEvent('nui:arena:throwItem', {
            ...
            if (this.draggedData.inventoryType == 'main') {
                if (this.mainInventory[this.draggedData.inventoryIndex]) {
                    ...
                    if (inventoryType == 'second') { // áthúzás second
                        this.sendEvent('nui:arena:moveToSecond', {
                            count: darab,
                            index: this.draggedData.inventoryIndex + 1,
                            droppedTo: index + 1
                        })
                        ...
                        this.sendEvent('nui:arena:moveInside', {
                            count: darab,
                            index: this.draggedData.inventoryIndex + 1,
                            droppedTo: index + 1,
                            inventoryType: 'main'
                ...
                if (this.secondInventory[this.draggedData.inventoryIndex]) {
                    ...
                    if (inventoryType == 'main') { // áthúzás inventoryba
                        ...
                        this.sendEvent('nui:arena:moveToFirst', {
                            count: darab,
                            index: this.draggedData.inventoryIndex + 1,
                            droppedTo: index + 1
                        })
        ...
        startDrag(inventoryType, index) {
            if (inventoryType == 'main') {
                if (this.shiftPressed) {
                    this.sendEvent('nui:arena:instantToSecond', parseInt(index + 1))
                    this.PlaySound('pop.wav')
                }
                else {
                ...
                if (this.shiftPressed) {
                    this.sendEvent('nui:arena:instantToMain', parseInt(index + 1))
                    this.PlaySound('pop.wav')
                } else {
